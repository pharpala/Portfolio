...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    .then(() => {
      ...
      setLoading(false)
      console.log(error)
      alert('Something went wrong, please try again or contact me at pranayharpalani@icloud.com')
  ...
  return (
    ...
    flex gap-10 overflow-hidden pt-12 mt-[80px] pb-[80px]">
      <motion.div
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <input 
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="What's your email account?"
              className="bg-tertiary py-4 px-6
              placeholder:text-secondary text-white
              rounded-lg outlined-none border-none 
              font-medium"
          ...
          <button
            ...
            outline-none w-fit font-bold text-white
